...
(function (root, factory) {
  ...
  const DICT = {
    de: {
      ...
      avatarCat_animals: 'Tiere',
      avatarCat_smileys: 'Smileys',
      avatarCat_wildAnimals: 'Wildtiere',
      avatarCat_sports: 'Sport',
      avatarCat_food: 'Essen',
    ...
    en: {
      ...
      avatarCat_animals: 'Animals',
      avatarCat_smileys: 'Smileys',
      avatarCat_wildAnimals: 'Wild animals',
      avatarCat_sports: 'Sports',
      avatarCat_food: 'Food',
